  ...
  return (
    <div id="about" className="row">
      <div id="aboutText" className="col-md-6">
        ...
        <button id="resumeLink" type="button" onClick={() => console.log('get resume')}>Get My Resume</button>
      </div>
      <div className="col-md-6">
        <div className="row skills-container">
          ...
          <div className="skills-wrapper col-md-6">
            ...
            <span id="frameworksHeader">Frameworks</span>
          ...
          <div className="skills-wrapper col-md-6">
            ...
            <span id="skillsHeader">Soft Skills</span>
            <div id="skills">
              {
